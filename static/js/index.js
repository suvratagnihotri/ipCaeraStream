...
socket.on('start_call', async () => {
  ...
  if (isRoomCreator) {
    localVideoComponent.style.width = "100%";
    localVideoComponent.style.height = "100%";
...
socket.on('webrtc_offer', async (event) => {
  ...
  if (!isRoomCreator) {
    ...
    remoteVideoComponent.style.height = "100%";
...
async function setLocalStream(mediaConstraints) {
  try {
    ...
    localVideoComponent.src = "http://localhost:5001/ipcameravideo"
  } catch (error) {
